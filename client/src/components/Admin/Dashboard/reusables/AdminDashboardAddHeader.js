...
const AdminDashboardAddHeader = ({ heading, buttonText, setOverlayShowing }) => {
  ...
  return (
    ...
    <StyledContainer justifyContent='space-between' alignItems='center' padding='1rem'>
      ...
      <StyledButtonRound backgroundColor={styledTheme.colors.logoRed} borderRadius={'8px'} color={styledTheme.colors.white} onClick={() => setOverlayShowing(true)}>
        {buttonText}
      </StyledButtonRound>
      <StyledBottomLine />
    </StyledContainer>
